					...
					<tr>
						<td colspan="1">
							<div class = "inputForm">
								...
								<div class = "input_div">								
								<input id = "projectName" len = "50" name = "projectName" type = "text"   value = "${projectName}" title = "必填项，不超过50个字"/>
								</div>
							</div>
						</td>
					</tr>
					...
					<tr> 
						<td colspan="1">
							<div class = "inputForm">
								...
								<div class = "input_div">
									<input class="italic" disabled value = "${projectNumber }" type="text" name="projectNumber" id = "projectNumber" property="projectNumber" len = "100" >
								</div>
							</div>
						</td>
					</tr>
					...
					<tr>	 
						<td colspan="1">
							<div class = "inputForm">
								<span>说明</span>
								<div class = "input_div">
									<textarea name="projectIntroduce" property="projectIntroduce" style="height:75px" len = "40" >${projectIntroduce}</textarea>
								</div>
							</div>
						</td>
					</tr>
					...
					<tr>
						<td colspan="1">
							<div class = "inputForm">
								...
								<div class = "input_div">
                                   <input id="endDate"     type="text"  name="endDate" value = "${endDate }" 
                                   onclick=" WdatePicker({dateFmt:'yyyy-MM-dd',enableInputMask:false,
								onpicking:function(dp){datePackerChange(dp,this)}})" readOnly="true"
					...
					<tr>	 
						<td colspan="1">
							<div class = "inputForm">
								<span>计划投入工时</span>
								<div class = "input_div">
									<input  len = "40"  name = "planHours"  id = "planHours" type="text" value = "${planHours } " title = "必须为8位以内整数" />
								</div>
							</div>
						</td>
					</tr>
						...
						<td colspan="1">
							<div class = "inputForm"  id="organInfo">
						        ...
						        <div class = "input_div"   id="organTree"   >
									...
									<input id = "deptName" len = "20" name = "deptName" type = "text" style = "width:92%;background-color:#efefef" readonly="readonly" class = "validNull" value = "${deptName}" />
