	...
	<div class="query-box-left">
		<form name="queryBox" action="" style="width:100%;padding-left:10px"   method="post" >
			...
			<div class="form-group col-xs-3">
				<label>组织名称：</label>
				<div class="controls">
					<select d = "deptCode" name = "deptCode" >
...
function queryListPro(load){
	...
	var cols = [
        ...
        　　　　{title:'批次号', name:'EMP_NAME', width:100, sortable:false, align:'center'},
        　　　　{title:'同步开始时间', name:'EMP_CODE', width:110, sortable:false, align:' center'},
	            {title:'同步结束时间', name:'BEGIN_DATE', width:100, sortable:false, align:'center'},
	            {title:'部门名称', name:'END_DATE', width:100, sortable:false, align:'center'},
	            {title:'项目类型', name:'FULL_TIME', width:150, sortable:false, align:'center'},
	            {title:'时间戳', name:'OVER_TIME', width:150, sortable:false, align:'center'}
        　　　　
	    		];
