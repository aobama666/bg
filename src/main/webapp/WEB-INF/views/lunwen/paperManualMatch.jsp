...
<head>
	...
	<link href="<%=request.getContextPath()%>/yszx/plugins/layui/css/layui.css" rel="stylesheet" type="text/css">
</head>
<body>
...
<div class="layui-container" style="margin-top: 15px;">
	...
	<!-- 本页面所需的js -->
 	...
 	<script src="<%=request.getContextPath()%>/js/lunwen/transfer.js"></script>
</body>
