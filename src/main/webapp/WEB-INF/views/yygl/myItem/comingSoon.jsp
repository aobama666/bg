...
<div>
    ...
    <div id="funcBtn" style="height: 35px;float:right">
        <div style="margin-left: 5px;" class='btn right ' onclick="myItem.toSendBack()" >退回</div>
        <div style="margin-left: 5px;" class='btn right ' onclick="myItem.toAgree()" >同意</div>
        <div style="margin-left: 5px;" class='btn right ' onclick="myItem.toAddSign()" >增加业务主管部门会签</div>
    </div>
