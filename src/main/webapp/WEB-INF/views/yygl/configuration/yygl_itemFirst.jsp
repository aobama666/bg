...
<!-- end    查询条件 -->
<div class='btn right deleteButton' onclick="roomList.itemFirstFordelete()" style="white-space: nowrap">删除</div>
<div class='btn right deleteButton' onclick="roomList.itemFirstForUpdata()" style="white-space: nowrap">修改</div>
<div class='btn right deleteButton' onclick="roomList.itemFirstForSave()" style="white-space: nowrap">新增</div>
