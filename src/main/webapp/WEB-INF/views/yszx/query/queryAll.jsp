...
<head>
	...
	<!-- 本页面所需的js -->
 	<script src="<%=request.getContextPath()%>/yszx/js/idea/queryAll.js"></script>
 	<style>
...
<body>
	...
	<!-- start    查询条件 -->
	<div class="sheach">
		<div class='content_top'><!-- 待办事项 -->综合查询<hr></div>	 
	...
	<div id="funcBtn" style="width:100%;height: 35px;margin-bottom:-35px;">
		<div class='btn right deleteButton' onclick="queryAll.exportEvent()" >导出</div>		
	</div>
	<!-- end   新增  修改  删除按钮 -->
