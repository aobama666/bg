...
<body>
	...
	<table class="visitOperate tableStyle specialTable">
		...
		<tr>
			...
			<td class="addInputStyle">
				  <input type="text"  id="contactUser"  name="contactUser"  class="validNull"  value = "${contactUser}"  content="联系人" title="必填项，中文或英文,字段长度不能超过 20"/>
			</td>
			<td>
	...
	<table class="visitPerson tableStyle specialTable">
		...
		<tr>
			...
			<td colspan="3" class="addInputStyle">
				<input  id="visitUnitName"   name="visitUnitName"  type="text"   class = "validNull"   len="50"    content="参观单位名称" value = "${visitUnitName}"  title="必填项  " />
			</td>
		</tr>
	</table>
