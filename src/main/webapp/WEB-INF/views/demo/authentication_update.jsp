...
<div class="form-box">
	...
	<div class="form-group col-xs-6">
		...
		<div class="controls">
			<div class="input-group date form_date bg-white" data-date-format="yyyy-mm-dd">
				<input type="text" name="publishDate" property="publishDate" readonly="true"></text>
	...
	<div class="form-group col-xs-6">
		...
		<div class="controls">
			<text name="sortOrder" property="sortOrder" ></text>
		</div>
	</div>
	<div class="form-group col-xs-12">
...
function forSave(){
	...
	if(checkResult){
		...
		$.ajax({
			type:"POST",
			url:"<%=request.getContextPath() %>/cepri_zhiyeshengya/authenticationWeb/ajaxSave.so?ran="+ran,
			data:param,
