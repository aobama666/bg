...
<head>
	...
	<title>计划统计-信息系统开发建设投入数据维护</title>
...
<!-- end    查询条件 -->
<div class='btn right deleteButton' onclick="roomList.messageOfDelete()" style="white-space: nowrap">删除</div>
<div class='btn right deleteButton' onclick="roomList.messageOfSave()" style="white-space: nowrap">新增</div>
...
<script src="<%=request.getContextPath()%>/yszx/js/plugins/datagrid2.0/js/jquery-tool.datagrid.js?verNo=<%=VersionUtils.verNo%>"></script>
<!-- datagrid表格.js   -->
<!-- 引入日期选择框 -->
...
<!-- 本页面所需的js -->
<script src="<%=request.getContextPath()%>/js/planCount/planInput/message.js"></script>
</body>
</html>