...
<head>
	...
	<title>计划统计-信息系统开发建设行数据-维护</title>
		...
		<table class="visitOperate tableStyle specialTable" style="width: 90%;">
			<tr>
				...
				<td class="addInputStyle" style="width: 200px">
					...
					<input type="text"  id="year"  name="year"   value="${YEAR}"  style="text-align: center;" disabled />
				</td>
			</tr>
			<tr>
				<td style="width: 145px">
				...
				<td class="addInputStyle" style="width: 200px">
					<input type="text"  id="planAmount"  name="planAmount"   value="${PLAN_AMOUNT}"  style="text-align: center;"  disabled />
				</td>
			</tr>
			<tr>
				<td style="width: 145px">
				...
				<td class="addInputStyle" style="width: 200px">
					<input type="text"  id="itemNumber"  name="itemNumber"   value="${ITEM_NUMBER}"   style="text-align: center;"   disabled/>
				</td>
			</tr>
			<tr>
				<td style="width: 145px">
