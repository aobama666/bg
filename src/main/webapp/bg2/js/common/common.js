...
var recommonedFile = {
		 ...
		 * @param awardIds
		 */
		buildTechRecommonedEvent:function(achType,awardIds){
			if(rewardType.techProGress==achType){
				location.href = "/TYGLPT/ky_reward/rest/kyrepawaawardinfo/createWordTechPro?ids="+awardIds;
			}else if(rewardType.standard==achType){
				location.href = "/TYGLPT/ky_reward/rest/kyrepawastandnewinfo/export?id="+awardIds;
			}else if(rewardType.finePaper==achType){
				location.href = "/TYGLPT/ky_reward/rest/kyrepawafinepaperinfo/createWord?id="+awardIds;
			}else if(rewardType.finePatent==achType){
				location.href = "/TYGLPT/ky_reward/rest/kyrepawafinepatentinfo/createWord?id="+awardIds;
			}else if(rewardType.fineSoft==achType){
				location.href = "/TYGLPT/ky_reward/rest/kyrepawafinesoftinfo/createWord?id="+awardIds;
			}else if(rewardType.fineGraph==achType){
				location.href = "/TYGLPT/ky_reward/rest/kyrepawafinegraphinfo/createWord?id="+awardIds;
			}
		}
}
...
$(function () {
    $.ajax({
        url:"/newtygl/planTask/token",
        dataType:"json",
        type:"get",
        async : false,
        success : function(data) {
            token = data.token;
            previewHost = data.hostName;
        }
    })
});
