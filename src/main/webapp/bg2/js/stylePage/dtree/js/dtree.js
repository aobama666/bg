...
this.config = {
    ...
    this.icon = {                   /* ָ������ͼ�� */
        ...
        folderOpen      : '',     /* ָ������ͼ�� */
        node            : '',            /* ָ������ͼ�� */
        empty           : '../js/stylePage/dtree/img/empty.gif',          /* �հ�ͼ�� */
        line            : '../js/stylePage/dtree/img/line.gif',           /* ����������ͼ�� */
        join            : '../js/stylePage/dtree/img/join.gif',           /* ���ˮƽ�����������ߵ�ͼ�� */
        joinBottom      : '../js/stylePage/dtree/img/joinbottom.gif',     /* �׶�������ͼ�� */
        plus            : '../js/stylePage/dtree/img/plus.gif',           /* �������ߵ�+ͼ�� */
        plusBottom      : '../js/stylePage/dtree/img/plusbottom.gif',     /* �������ߵĵ׶�+ͼ�� */
        minus           : '../js/stylePage/dtree/img/minus.gif',          /* �������ߵ�-ͼ�� */
        minusBottom     : '../js/stylePage/dtree/img/minusbottom.gif',    /* �������ߵĵ׶�-ͼ�� */
        nlPlus          : '../js/stylePage/dtree/img/nolines_plus.gif',   /* ���������ߵ�+ͼ�� */
        nlMinus         : '../js/stylePage/dtree/img/nolines_minus.gif'   /* ���������ߵ�-ͼ�� */
    };
	this.obj = objName;
	this.aNodes = [];
	this.aIndent = [];
