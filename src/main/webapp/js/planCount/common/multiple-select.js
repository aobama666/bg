        ...
        fSelect.prototype = {
                ...
                $element.children().each(function(i, el) {
                    ...
                    if ('optgroup' == $el.prop('nodeName').toLowerCase()) {
                        ...
                        choices += '<div class="fs-option' + selected + '" data-value="' + $el.prop('value') + '">' +
                            ...
                            '<div class="fs-option-label">' + $el.html() + '</div></div>';
                    }
                });
            ...
            reloadDropdownLabel: function() {
                ...
                this.$wrap.find('.fs-option.selected').each(function(i, el) {
                    var  values  =$(el).find('.fs-option-label').text()
                    labelText.push(values);
                    var keys= $(el).attr('data-value');
                    keyText.push(keys);
                });
                ...
                this.$wrap.find('.fs-label-new').val(keyText) ;
