...
roomList.forDetails = function (id) {
    var url = "/bg/planInput/stockRightOfUpdata?id="+id;
    layer.open({
                type:2,
 ...
 * 删除
 */
roomList.stockRightOfDelete= function(){
 ...
 * 新增
 */
roomList.stockRightOfSave= function(){
    var url = "/bg/planInput/stockRightOfSave";
    layer.open({
        type:2,
