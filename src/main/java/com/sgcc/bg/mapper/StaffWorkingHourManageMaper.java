...
public interface StaffWorkingHourManageMaper {
	...
	List<Map<String, String>> getWorkHourInfoByCondition(
			@Param("deptIds")String deptIds,@Param("startDate")String startDate, @Param("endDate")String endDate, 
			@Param("deptCode")String deptCode,@Param("category")String category,
			@Param("proName")String proName, @Param("empName")String empName, 
			@Param("status")String status, @Param("start")String start,  @Param("end")String end);
