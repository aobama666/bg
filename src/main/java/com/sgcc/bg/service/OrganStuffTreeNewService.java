...
public interface OrganStuffTreeNewService {
	 ...
	 * @param limit 权限控制:按权限查询，如果是 'yes',按用户部门或单位权限查询  ，否则，查询所有
	 * @param funcType 权限控制: limit=yes 功能类型   YYGL BGGL
	 * @param dataSrc 数据来源：type=RLZY 人资专用 SRC = 1，其他为报工默认 SRC = 0 或 2
	 * @param userName 权限控制:登录账号 epri_xxxx
	 * @param 显示控制：show=PART 部分显示   默认为所有
	 * @return
	 */
	List<Map<String, Object>> queryAllOrganTree(String rootId,String level,String limit,String funcType,String dataSrc,String userName,String show);
